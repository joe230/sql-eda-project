 ...
 * Tabla de calendario
 * 
 * El trimestre se genera automaticamente dependiendo del mes del año y
 * con STORED se guarda en memoria para que las consultas sean mas rapidas
 */
...
-- Lo hago en sell_date por ser la columna que mas se usara
